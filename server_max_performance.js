// =========================================================================
// PHIÊN BẢN SỨC MẠNH TỐI ĐA (DÀNH CHO VPS 2GB RAM TRỞ LÊN)
// Chế độ này sẽ bật sẵn 5 trình duyệt ẩn danh cùng lúc và cho phép 2 trình duyệt
// cùng tranh nhau cào dữ liệu cho 1 đơn hàng (Race Mode) để lấy kết quả nhanh nhất.
// Tuyệt đối không dùng bản này cho máy chủ 512MB RAM vì sẽ gây sập nguồn (OOM).
// =========================================================================
...
async function bootAllBrowsers() {
    ...
    for (const proxy of proxies) {
        if (goodCount >= 5) break; // Boot tối đa 5 trình duyệt để sẵn sàng phục vụ
...
// Chế độ 5 trình duyệt: Tăng độ song song lên 2 để có thể chạy Race Mode
